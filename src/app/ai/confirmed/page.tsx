    ...
    <div className="min-h-screen flex items-center justify-center">
      <div className="text-center max-w-md p-8">
        ...
        <div className="flex justify-center space-x-4 mb-8">
          <a href="https://www.linkedin.com/company/times8" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-white/70 hover:text-times8-purple transition-colors">
          ...
          <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-white/70 hover:text-times8-purple transition-colors">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
